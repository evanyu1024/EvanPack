...
import com.evan.demo.application.BaseApp;
...
public class SPUtils {
    ...
    public static boolean put(String key, String value, String spName) {
        SharedPreferences sp = BaseApp.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    ...
    public static boolean remove(String key) {
        SharedPreferences sp = BaseApp.getContext().getSharedPreferences(DEFAULT_SP_NAME, Context.MODE_PRIVATE);
        return sp.edit().remove(key).commit();
    }
